...
<div id="page-wrapper">
    <div id="page-inner">
        ...
        <%
        	...
        	if("1".equals(err)) {
        		out.print("<span style='color: red; font-weight: bold; padding: 5px'>Có lỗi khi sửa</span>");
        	}
        	if("2".equals(err)) {
                            ...
                            <div class="col-md-12">
                                <form action="<%=request.getContextPath() %>/admin/user/edit?id=<%=id %>"  role="form" method="post" id="form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="username" value="<%if(username != null) out.print(username); %>" name="username" disabled="disabled" class="form-control" />
                                    </div>
                                    <div class="form-group">
