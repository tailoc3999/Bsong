                                ...
                                <form role="form" method="post" id="form" action="<%=request.getContextPath()%>/admin/cat/add">
                                    <div class="form-group">
                                        ...
                                        <%
                                        	if ("1".equals(err)){
                                        %>
                                        <label id ="name-error" class="error" for="name">Không được nhập ký tự đặc biệt</label>
                                        <%} %>
                                        <%
                                        	if ("2".equals(err)) {
                                        		out.print("<label id =\"name-error\" class=\"error\" for=\"name\">Tên danh mục ít nhất 5 kí tự</label>");
                                        	}
                                        %>
                                    </div>
